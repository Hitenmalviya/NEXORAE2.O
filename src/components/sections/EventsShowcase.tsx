...
export default function EventsShowcase() {
  ...
  return (
    <section className="relative min-h-screen py-16 sm:py-20 bg-void overflow-hidden flex flex-col justify-center select-none" id="events">
      ...
      {/* Section Header */}
      <div className="relative z-10 w-full max-w-[1400px] mx-auto text-center px-4 sm:px-6 mb-6 sm:mb-8 overflow-hidden">
