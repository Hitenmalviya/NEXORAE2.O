...
const TIMELINE_DATA: TimelineItem[] = [
  ...
  },
  {
    ...
    title: 'Arcade Alley',
    category: 'Fun',
    organizer: 'IEEE GCET SB',
    description: 'Arcade Alley brings the campus to life with exciting games, student-run stalls, and activities. Play, explore, and dive into an evening packed with fun, creativity, and entertainment at every turn.',
    venue: 'Front Lawn',
    poster: '/posters/Frame 39.png',
    status: 'upcoming',
  },
  ...
  },
  {
    ...
    category: 'Fun',
    organizer: 'IEEE GCET SB',
    description: 'Showcase your talent through solo and group performances, from dance and singing to creative acts. Perform on stage or enjoy the excitement from the audience.',
    venue: 'Auditorium',
    poster: '/posters/Frame 60.png',
    status: 'upcoming',
  },
  ...
  },
  {
    ...
    category: 'Fun',
    organizer: 'IEEE GCET SB',
    description: 'Experience the vibrant tradition of Gujarati Dayro featuring Kushal Gadhvi, where music, storytelling, and cultural charm come together.',
    venue: 'GCET Auditorium',
    poster: '/posters/Frame 59.png',
    status: 'upcoming',
  },
];
